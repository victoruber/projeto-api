...
public class TrabalhoRecursos {
    ...
    public ResponseEntity<Trabalho> addTrabalho(@RequestBody Trabalho trabalho){
        log.info("Trabalho Gravado: " +trabalho.toString());
    ...
    public ResponseEntity<String> remove(@PathVariable("id") Long id) {
        ...
        try {
            ...
            return ResponseEntity.ok("Registros Deletados");

        } catch (Exception e) {

            return ResponseEntity.badRequest().body("Registros nao pode ser removidos" + e.getMessage());
        }
    }
